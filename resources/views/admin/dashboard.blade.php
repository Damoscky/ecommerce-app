                        ...
                        <div class="widget widget-one">
                            ...
                            <div class="w-chart">
                                <div class="w-chart-section">
                                    <div class="w-detail">
                                        <p class="w-title">Total Vendors</p>
                                        <p class="w-stats">{{ $data['totalVendor'] }}</p>
                                    </div>
                                ...
                                <div class="w-chart-section">
                                    <div class="w-detail">
                                        ...
                                        <p class="w-stats">{{ $data['totalCustomer'] }}</p>
                                    </div>
                                    <div class="w-chart-render-one">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                        <div class="widget widget-card-four">
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info">
                                        <h6 class="value">$ {{ number_format((float)($data['totalSales']), 2, '.', '') }}</h6>
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-gradient-secondary" role="progressbar" style="width: {{ $data['totalSales'] }}%" aria-valuenow="{{ $data['totalSales'] }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="vistorsBrowser">
                                    <div class="browser-list">
                                        ...
                                        <div class="w-browser-details">
                                            <div class="w-browser-info">
                                                <h6>Total Categor(ies)</h6>
                                                <p class="browser-count">{{ $data['totalCategory'] }}</p>
                                            </div>
                                            <div class="w-browser-stats">
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-primary" role="progressbar" style="width: {{ $data['totalCategory'] }}%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="browser-list">
                                        ...
                                        <div class="w-browser-details">
                                            ...
                                            <div class="w-browser-info">
                                                <h6>Total Subcategor(ies)</h6>
                                                <p class="browser-count">{{ $data['totalSubCategory'] }}</p>
                                            </div>

                                            <div class="w-browser-stats">
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-danger" role="progressbar" style="width: {{ $data['totalSubCategory'] }}%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="browser-list">
                                        ...
                                        <div class="w-browser-details">
                                            ...
                                            <div class="w-browser-info">
                                                <h6>Children Categor(ies)</h6>
                                                <p class="browser-count">{{ $data['totalChildCategory'] }}</p>
                                            </div>

                                            <div class="w-browser-stats">
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-warning" role="progressbar" style="width: {{ $data['totalChildCategory'] }}%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
