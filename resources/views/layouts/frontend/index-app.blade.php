...
<head>
    ...
    <title>{{config('app.name', 'Reiss Edwards E-commerce Application')}}</title>
    <link rel="preconnect" href="https://fonts.gstatic.com/">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap">
    <link rel="stylesheet" href="{{ asset('frontend') }}/assets/css/font-futura.css">
...
<body class="lazy_icons btnt4_style_2 zoom_tp_2 css_scrollbar template-index js_search_true cart_pos_side kalles_toolbar_true hover_img2 swatch_style_rounded swatch_list_size_small label_style_rounded wrapper_boxed header_full_true header_sticky_true des_header_8 h_banner_true top_bar_true prs_bordered_grid_1 search_pos_full lazyload nt_bg_lz" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/body-bg.jpg">
...
<div id="nt_wrapper">
    ...
    <!-- header -->
    <header id="ntheader" class="ntheader header_8 h_icon_iccl">
        <h1 class="h2 site-header__logo dn">Reiss Edwards E-commerce Application</h1>
                        ...
                        <div class="row al_center">
                            ...
                            <div class="col-lg-4 col-12 tc col-md-12 tr_lg dn_true_1024">
                                <div class="nt_currency pr cg currencies sp_currencies wsn dib cur_stt_0">
                                    <span class="current dib flagst4 lazyload flagst4-sm flagst4-USD">USD</span><i class="facl facl-angle-down ml__5"></i>
                        ...
                        <div class="row al_center css_h_se">
                            ...
                            <div class="col-lg-3 col-md-4 col-6 tc tl_lg">
                                <div class="branding ts__05 lh__1">
                                    <a class="dib" href="{{route('pages.index')}}">
                                        <img class="w__100px logo_normal dn db_lg" style="height: 100px; width:200px" src="http://lanop.co.uk/wp-content/uploads/2020/10/Reiss-Edwards.png" alt="Reiss Edwards E-commerce Application">
                                        <img class="w__100px logo_sticky dn" src="http://lanop.co.uk/wp-content/uploads/2020/10/Reiss-Edwards.png" alt="Reiss Edwards E-commerce Application">
                                        <img class="w__100px logo_mobile dn_lg" src="http://lanop.co.uk/wp-content/uploads/2020/10/Reiss-Edwards.png" alt="Reiss Edwards E-commerce Application">
                                    </a>
                                </div>
                            </div>
                            <div class="col-6 dn db_lg cl_h_search">
                                <form action="#" method="get" class="h_search_frm js_frm_search pr">
                                ...
                                <div class="nt_action in_flex al_center cart_des_1">
                                    ...
                                    @if (Auth::user())
                                        <div class="my-account ts__05 pr dn db_md">
                                            <a class="cb chp db push_side" href="{{ route('auth.logout') }}">Logout</a>

                                        </div>
                                        <a class="icon_like cb chp pr dn db_md js_link_wis" href="#">
                                            <i class="iccl iccl-heart pr"><span class="op__0 ts_op pa tcount bgb br__50 cw tc">5</span></i>
                                        </a>
                        ...
                        <div class="row no-gutters al_center">
                            <div class="col-auto ha8_cat">
                                ...
                                <div class="h_cat_nav pa op__0">
                                    <ul class="lazy_menu lazyload lazy_h_cat">
                                        <li class="cat_menu-0">
                                            <a class="lh__1 flex al_center pr" href="#"><i class="las la-baby"></i>Accessories</a>
                                        </li>
                                        <li class="cat_menu-0">
                                            <a class="lh__1 flex al_center pr" href="#"><i class="las la-baby-carriage"></i>Baby Troller</a>
                                        </li>
                                        <li class="cat_menu-0">
                                            <a class="lh__1 flex al_center pr" href="#"><i class="las la-tshirt"></i>Clothing</a>
                                        </li>
                                        <li class="cat_menu-0">
                                            <a class="lh__1 flex al_center pr" href="#"><i class="las la-utensils"></i>Feeding</a>
                                        </li>
                                        <li class="cat_menu-0">
                                            <a class="lh__1 flex al_center pr" href="#"><i class="las la-las la-hippo"></i>Toys</a>
                                        </li>
                                        <li class="cat_menu-0">
                                            <a class="lh__1 flex al_center pr" href="#"><i class="las la-las la-hat-cowboy-side"></i>Hat</a>
                                        </li>
                                        <li class="cat_menu-0">
                                            <a class="lh__1 flex al_center pr" href="#"><i class="las la-las la-shoe-prints"></i>Shoes</a>
                                        </li>
                                        <li class="cat_menu-0">
                                            <a class="lh__1 flex al_center pr" href="#"><i class="las la-home"></i>At Home</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <nav class="nt_navigation tl hover_side_up nav_arrow_false">
                                    <ul id="nt_menu_id" class="nt_menu in_flex wrap al_center">
                                        <li class="type_mega menu_wid_cus menu-item has-children menu_has_offsets menu_center pos_center">
                                            <a class="lh__1 flex al_center pr" href="{{route('pages.index')}}">Products</a>
                                        </li>
                                        <li class="type_mega menu_wid_cus menu-item has-children menu_has_offsets menu_center pos_center">
                                            <a class="lh__1 flex al_center pr" href="#">Sale</a>
                                                ...
                                                <div class="container megamenu-content-1000px">
                                                    <div class="row lazy_menu lazyload lazy_menu_mega" data-jspackery='{ "itemSelector": ".sub-column-item","gutter": 0,"percentPosition": true,"originLeft": true }'>
                                                        ...
                                                        <div class="type_mn_pr menu-item sub-column-item col-10">
                                                            <div class="prs_nav js_carousel nt_slider products nt_products_holder row al_center row_pr_1 cdt_des_3 round_cd_false nt_cover ratio_nt position_8 equal_nt flickity_prev_disable flickity_next_disable" data-flickity='{"imagesLoaded": 0,"adaptiveHeight": 0, "contain": 1, "groupCells": "100%", "dragThreshold" : 5, "cellAlign": "left","wrapAround": 1,"prevNextButtons": 1,"percentPosition": 1,"pageDots": 0, "autoPlay" : 0, "pauseAutoPlayOnHover" : 1, "rightToLeft": false }'>
                                                                <div class="col-lg-3 col-md-12 col-12 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1 is-selected">
                                                                    <div class="product-inner pr">
                                                                        <div class="product-image pr oh lazyload">
                                                                            <a class="db" href="product-detail-layout-01.html">
                                                                                <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-01.jpg"></div>
                                                                            </a>
                                                                            <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                                                                <div class="pr_lazy_img back-img pa nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-02.jpg"></div>
                                                                            </div>
                                                                ...
                                                                <div class="col-lg-3 col-md-12 col-12 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1 is-selected">
                                                                    <div class="product-inner pr">
                                                                        <div class="product-image pr oh lazyload">
                                                                            ...
                                                                            <a class="db" href="product-detail-layout-01.html">
                                                                                <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-03.jpg"></div>
                                                                            </a>
                                                                            <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                                                                <div class="pr_lazy_img back-img pa nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-04.jpg"></div>
                                                                            </div>
                                                                            <div class="nt_add_w ts__03 pa">
                                                                                <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right">
                                                                                    <span class="tt_txt">Add to Wishlist</span><i class="facl facl-heart-o"></i>
                                                                ...
                                                                <div class="col-lg-3 col-md-12 col-12 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1 is-selected">
                                                                    <div class="product-inner pr">
                                                                        <div class="product-image pr oh lazyload">
                                                                            <a class="db" href="product-detail-layout-01.html">
                                                                                <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-05.jpg"></div>
                                                                            </a>
                                                                            <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                                                                <div class="pr_lazy_img back-img pa nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-06.jpg"></div>
                                                                            </div>
                                                                            <div class="nt_add_w ts__03 pa">
                                                                                <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right">
                                                                                    <span class="tt_txt">Add to Wishlist</span><i class="facl facl-heart-o"></i>
                                                                    ...
                                                                    <div class="product-inner pr">
                                                                        <div class="product-image pr oh lazyload">
                                                                            <span class="tc nt_labels pa pe_none cw">
                                                                                <span class="onsale nt_label"><span>-16%</span></span>
                                                                            </span>
                                                                            <a class="db" href="product-detail-layout-01.html">
                                                                                <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-07.jpg"></div>
                                                                            </a>
                                                                            <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                                                                <div class="pr_lazy_img back-img pa nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-08.jpg"></div>
                                                                            </div>
                                                                            <div class="nt_add_w ts__03 pa">
                                                                                <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right">
                                                                                    <span class="tt_txt">Add to Wishlist</span><i class="facl facl-heart-o"></i>
                                                                        ...
                                                                        <div class="product-info mt__15">
                                                                            ...
                                                                            <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                                                                <span data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-07.jpg" class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span class="tt_txt">Grey</span><span class="swatch__value bg_color_grey lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/dot-01.jpg"></span></span>
                                                                                <span data-bgset="{{ asset('frontend') }}/assets/images/home-kids/pr-08.jpg" class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span class="tt_txt">Brown</span><span class="swatch__value bg_color_brown lazyload" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/dot-01.jpg"></span></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <li class="type_mega menu_wid_cus menu-item has-children menu_has_offsets menu_center pos_center">
                                            <a class="lh__1 flex al_center pr" href="{{route('pages.index')}}">Become a Vendor</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                            <div class="col-3 fs__12 ha8_txt tr">
                                @if (Auth::user())
                                    <a href="#" class="ttip_nt tooltip_top mr__10">
                                        <span class="tt_txt"><span class="__cf_email__" data-cfemail="264d474a4a43556642494b474f480845494b">
                                        <i class="las la-user fs__14 mr__5"></i><span>Welcome! {{ Auth::user()->lastname }} {{ Auth::user()->firstname }}</span>
                                    </a>
                                @else
                                    <a href="mailto:support@reissedwards.com" class="ttip_nt tooltip_top mr__10">
                                        <span class="tt_txt"><span class="__cf_email__" data-cfemail="264d474a4a43556642494b474f480845494b">[email&#160;protected]</span></span>
    ...
    <!--newsletter section-->
<div class="kalles-section nt_section type_newsletter2">
    <div class="kalles-kids__newsletter nt_bg_overlay pr oh cover_norepeat lazyload nt_parallax_false" data-bgset="{{ asset('frontend') }}/assets/images/home-kids/newsletter-bg.png">
        <div class="newsletter_se container color_scheme_light newl_des_1 pr z_100">
            <div class="row fl_center al_center tc tl_lg">
                <div class="col-12 col-lg-6">
                    <h3 class="section-title mb__20"><span>Subscribe Now! </span></h3>
                    <p class="section-subtitle mg__0">Newsletter For Getting Daily Updates</p>
                </div>
                <div class="col-12 col-lg-6 col-new">
                    <form action="#" class="pr z_100 mc4wp-form" method="post">
                    ...
                    <div class="widget widget_text widget_logo">
                        ...
                        <div class="widget_footer">
                            <div class="footer-contact">
                                <p>
                                    <a class="d-block" href="{{route('pages.index')}}">
                                        <img class="w__100 mb__15 lz_op_ef lazyload max-width__95px" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20220%2066%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" alt="Reiss Edwards E-commerce Application" data-src="{{ asset('frontend') }}/assets/images/svg/kalles.svg">
                                    </a>
                                </p>
                                <p>
                                ...
                                <p>
                                    <i class="pegk pe-7s-mail"></i> <span><a href="https://themes.the4.co/cdn-cgi/l/email-protection#1b7874756f7a786f5b7874766b7a756235787476"><span class="__cf_email__" data-cfemail="2c4f4342584d4f586c4f43415c4d4255024f4341">[email&#160;protected]</span></a></span>
                                </p>
                                <p>
                                    <i class="pegk pe-7s-call"></i> <span>+001 2233 456 </span>
                                </p>
                                <div class="nt-social">
                ...
                <div class="col-lg-2 col-md-6 col-12 mb__50 order-lg-2 order-1">
                    <div class="widget widget_nav_menu">
                        ...
                        <div class="menu_footer widget_footer">
                            <ul class="menu">
                                <li class="menu-item"><a href="#">Toys</a></li>
                                <li class="menu-item"><a href="#">Baby Troller</a></li>
                                <li class="menu-item"><a href="#">Girls Collection</a></li>
                                <li class="menu-item"><a href="#">Boys Collection</a></li>
                                <li class="menu-item"><a href="#">Kids Accessories</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb__50 order-lg-5 order-1">
                    <div class="widget widget_text">
                        ...
                        <div class="widget_footer newl_des_1">
                            ...
                            <p class="mt__20">
                                <img class="w__100 lz_op_ef lazyload max-width__265px" data-src="{{ asset('frontend') }}/assets/images/home-kids/trust_img_02.png" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20197%2020%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" alt="">
                            </p>
                        </div>
                    </div>
                </div>
...
<div id="kalles-section-footer_bot" class="kalles-section footer__bot">
    <div class="footer__bot_wrap pt__20 pb__20">
        <div class="container pr tc">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 col_1">Copyright © {{ date('Y') }} Reiss Edwards. Powered by<a href="#"> Akinwunmi Damilola</a>
                </div>
        ...
        <div class="images">
            <div class="product-images-slider tc equal_nt nt_slider nt_carousel_qv p-thumb_qv nt_contain ratio_imgtrue position_8" data-flickity='{ "fade":true,"cellSelector": ".q-item:not(.is_varhide)","cellAlign": "center","wrapAround": true,"autoPlay": false,"prevNextButtons":true,"adaptiveHeight": true,"imagesLoaded": false, "lazyLoad": 0,"dragThreshold" : 0,"pageDots": true,"rightToLeft": false }'>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-01.jpg"></span>
                </div>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-02.jpg"></span>
                </div>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-03.jpg"></span>
                </div>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-04.jpg"></span>
                </div>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-05.jpg"></span>
                </div>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-06.jpg"></span>
                </div>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-07.jpg"></span>
                </div>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-08.jpg"></span>
                </div>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-09.jpg"></span>
                </div>
                <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100" data-mdtype="image">
                    <span class="nt_bg_lz lazyload" data-bgset="{{ asset('frontend') }}/assets/images/quick_view/pr-10.jpg"></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-auto cl_pr_img">
        <div class="pr oh qs_imgs_wrap">
            <div class="row equal_nt qs_imgs nt_slider nt_carousel_qs p-thumb_qs" data-flickity='{"fade":false,"cellSelector":".qs_img_i","cellAlign":"center","wrapAround":true,"autoPlay":false,"prevNextButtons":false,"adaptiveHeight":true,"imagesLoaded":false,"lazyload":0,"dragThreshold":0,"pageDots":false,"rightToLeft":false}'>
                <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz" data-bgset="{{ asset('frontend') }}/assets/images/quick_shop/p_qs_01.jpg"></div>
                <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz" data-bgset="{{ asset('frontend') }}/assets/images/quick_shop/p_qs_02.jpg"></div>
                <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz" data-bgset="{{ asset('frontend') }}/assets/images/quick_shop/p_qs_03.jpg"></div>
                <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz" data-bgset="{{ asset('frontend') }}/assets/images/quick_shop/p_qs_04.jpg"></div>
                <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz" data-bgset="{{ asset('frontend') }}/assets/images/quick_shop/p_qs_05.jpg"></div>
            </div>
        </div>
    </div>
    <div class="col cl_pr_title tc">
        <h3 class="product-title pr fs__16 mg__0 fwm"><a class="cd chp" href="product-detail-layout-01.html">Cluse La Boheme Rose Gold</a>
        </h3>
...
<div class="mini_cart_wrap">
            ...
            <div class="mini_cart_items js_cat_items lazyload">
                <div class="mini_cart_item js_cart_item flex al_center pr oh">
                    ...
                    <a href="product-detail-layout-01.html" class="mini_cart_img">
                        <img class="w__100 lazyload" data-src="{{ asset('frontend') }}/assets/images/mini-cart/mini-cart-01.jpg" width="120" height="153" alt="" src="data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMjAiIGhlaWdodD0iMTUzIiB2aWV3Qm94PSIwIDAgMTIwIDE1MyI+PC9zdmc+">
                    </a>
                ...
                <div class="mini_cart_item js_cart_item flex al_center pr oh">
                    <div class="ld_cart_bar"></div>
                    <a href="product-detail-layout-01.html" class="mini_cart_img">
                        <img class="w__100 lazyload" data-src="{{ asset('frontend') }}/assets/images/mini-cart/mini-cart-02.jpg" width="120" height="153" alt="" src="data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMjAiIGhlaWdodD0iMTUzIiB2aWV3Qm94PSIwIDAgMTIwIDE1MyI+PC9zdmc+">
                    </a>
                    <div class="mini_cart_info">
                ...
                <div class="mini_cart_item js_cart_item flex al_center pr oh">
                    <div class="ld_cart_bar"></div>
                    <a href="product-detail-layout-01.html" class="mini_cart_img">
                        <img class="w__100 lazyload" data-src="{{ asset('frontend') }}/assets/images/mini-cart/mini-cart-03.jpg" width="120" height="153" alt="" src="data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMjAiIGhlaWdodD0iMTUzIiB2aWV3Qm94PSIwIDAgMTIwIDE1MyI+PC9zdmc+">
                    </a>
                    <div class="mini_cart_info">
    ...
    <div class="mini_cart_footer js_cart_footer">
        ...
        <div class="cat_img_trust mt__10 lazyload">
            <img class="w__100 lz_op_ef" src="{{ asset('frontend') }}/assets/images/trust_img2.png" width="360" height="46" alt="">
        </div>
    </div>
</div>
            ...
            <div class="js_prs_search row fl_center">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-02.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-03.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-04.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-05.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-06.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-07.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-08.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-09.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-10.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-11.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-12.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-13.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-14.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-15.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
                ...
                <div class="col-auto tc">
                    <div class="row mb__10 pb__10">
                        <div class="col-12">
                            <div class="img_fix_search">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201128%201439%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lz_op_ef lazyload" alt="" data-bgset="{{ asset('frontend') }}/assets/images/home-fashion-9/pr-s-16.jpg"></a>
                            </div>
                        </div>
                        <div class="col-12 mt__10">
...
<div id="kalles-section-mb_nav" class="kalles-section">
    <ul id="menu_mb_ul" class="nt_mb_menu">
        <li class="menu-item menu-item-has-children only_icon_false">
            <a href="home-classic.html"><span class="nav_link_txt flex al_center">Products</span><span class="nav_link_icon ml__5"></span></a>
        </li>
        <li class="menu-item menu-item-has-children only_icon_false">
            <a href="home-classic.html"><span class="nav_link_txt flex al_center">Vendors</span><span class="nav_link_icon ml__5"></span></a>
        </li>
        <li class="menu-item menu-item-has-children only_icon_false">
            <a href="product-detail-layout-01.html"><span class="nav_link_txt flex al_center">Sales</span><span class="nav_link_icon ml__5"></span></a>
            <ul class="sub-menu">
                <li class="menu-item">
        ...
        <li class="menu-item menu-item-infos">
            ...
            <div class="menu_infos_text">
                <i class="pegk pe-7s-call fwb mr__10"></i>+01 23456789<br><i class="pegk pe-7s-mail fwb mr__10"></i><a class="cg" href="https://themes.the4.co/cdn-cgi/l/email-protection#56353a3723331632393b373f387835393b"><span class="__cf_email__" data-cfemail="85e6e9e4f0e0c5e1eae8e4ecebabe6eae8">[email&#160;protected]</span></a>
            </div>
        </li>
        <li class="menu-item menu-item-has-children only_icon_false currencies">
            ...
            <ul class="sub-menu">
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-AUD" href="#" data-currency="AUD">AUD</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-CAD" href="#" data-currency="CAD">CAD</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-DKK" href="#" data-currency="DKK">DKK</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-EUR" href="#" data-currency="EUR">EUR</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-GBP" href="#" data-currency="GBP">GBP</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-HKD" href="#" data-currency="HKD">HKD</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-JPY" href="#" data-currency="JPY">JPY</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-NZD" href="#" data-currency="NZD">NZD</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-SEK" href="#" data-currency="SEK">SEK</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-SGD" href="#" data-currency="SGD">SGD</a>
                </li>
                <li>
                    <a class="currency-item cg db flagst4 lazyload flagst4-sm flagst4-USD selected" href="#" data-currency="USD">USD</a>
                </li>
            </ul>
        </li>
    </ul>
...
@toastr_js
@toastr_render
<script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{ asset('frontend') }}/assets/js/jquery-3.5.1.min.js"></script>
